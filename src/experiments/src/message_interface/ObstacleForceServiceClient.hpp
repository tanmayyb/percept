...
namespace message_interface
{
    ...
    class ObstacleForceServiceClient
                                              ...
                                              percept_interfaces::srv::AgentStateToCircForce>
    {
      ...
      public:
        ObstacleForceServiceClient(sackmesser_ros::Interface *interface, const std::string &ns, const std::string &callback_request,
                                   const std::string &callback_response);

        virtual ~ObstacleForceServiceClient();
