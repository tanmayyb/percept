...
#include <message_interface/VelocityHeuristicForceServiceClient.hpp>

namespace message_interface
{

    VelocityHeuristicForceServiceClient::VelocityHeuristicForceServiceClient(sackmesser_ros::Interface *interface, const std::string &ns,
    ...
    VelocityHeuristicForceServiceClient::~VelocityHeuristicForceServiceClient() = default;

    VelocityHeuristicForceServiceClient::Message::Request::SharedPtr VelocityHeuristicForceServiceClient::encodeRequest(
      const ga_circular_fields_planner::ObstacleForceRequest &request) const
    {
        auto request_msg = std::make_shared<VelocityHeuristicForceServiceClient::Message::Request>();
    ...
    ga_circular_fields_planner::ObstacleForceResponse VelocityHeuristicForceServiceClient::decodeResponse(
...
REGISTER_CLASS(sackmesser_ros::base::CallbackClient, message_interface::VelocityHeuristicForceServiceClient, "velocity_heuristic_force");