...
//
#include <gafro_ros2/publisher/LineVector.hpp>

namespace gafro_ros
{
    LineVector::LineVector(sackmesser_ros::Interface *interface, const std::string &name)
      : sackmesser_ros::Publisher<visualization_msgs::msg::MarkerArray, std::vector<gafro::Line<double>>>(interface, name)
    {
    ...
    visualization_msgs::msg::MarkerArray LineVector::createMessage(const std::vector<gafro::Line<double>> &lines) const
    {
        visualization_msgs::msg::MarkerArray lines_msg;
        ...
        for (const auto &line : lines)
        {
            ...
            lines_msg.markers.push_back(line_msg);
        }
...
REGISTER_CLASS(sackmesser_ros::base::Publisher, gafro_ros::LineVector, "gafro_line_vector");