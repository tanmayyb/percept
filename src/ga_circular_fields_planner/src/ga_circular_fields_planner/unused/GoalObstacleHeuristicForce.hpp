...
namespace ga_circular_fields_planner
{
    ...
    class GoalObstacleHeuristicForce : public Force
    {
      public:
        GoalObstacleHeuristicForce(const sackmesser::Interface::Ptr &interface, const std::string &name);

        virtual ~GoalObstacleHeuristicForce();
