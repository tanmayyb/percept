...
#include <message_interface/APFHeuristicForceServiceClient.hpp>

namespace message_interface
{

    APFHeuristicForceServiceClient::APFHeuristicForceServiceClient(sackmesser_ros::Interface *interface, const std::string &ns,
    ...
    APFHeuristicForceServiceClient::~APFHeuristicForceServiceClient() = default;

    APFHeuristicForceServiceClient::Message::Request::SharedPtr APFHeuristicForceServiceClient::encodeRequest(
      const ga_circular_fields_planner::ObstacleForceRequest &request) const
    {
        auto request_msg = std::make_shared<APFHeuristicForceServiceClient::Message::Request>();
    ...
    ga_circular_fields_planner::ObstacleForceResponse APFHeuristicForceServiceClient::decodeResponse(
...
REGISTER_CLASS(sackmesser_ros::base::CallbackClient, message_interface::APFHeuristicForceServiceClient, "apf_heuristic_force");