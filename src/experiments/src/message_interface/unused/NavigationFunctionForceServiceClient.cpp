...
#include <message_interface/NavigationFunctionForceServiceClient.hpp>

namespace message_interface
{

    NavigationFunctionForceServiceClient::NavigationFunctionForceServiceClient(sackmesser_ros::Interface *interface, const std::string &ns,
    ...
    NavigationFunctionForceServiceClient::~NavigationFunctionForceServiceClient() = default;

    NavigationFunctionForceServiceClient::Message::Request::SharedPtr NavigationFunctionForceServiceClient::encodeRequest(
      const ga_circular_fields_planner::ObstacleForceRequest &request) const
    {
        auto request_msg = std::make_shared<NavigationFunctionForceServiceClient::Message::Request>();
    ...
    ga_circular_fields_planner::ObstacleForceResponse NavigationFunctionForceServiceClient::decodeResponse(
...
REGISTER_CLASS(sackmesser_ros::base::CallbackClient, message_interface::NavigationFunctionForceServiceClient, "navigation_function_force");