...
#include <message_interface/GoalHeuristicForceServiceClient.hpp>

namespace message_interface
{

    GoalHeuristicForceServiceClient::GoalHeuristicForceServiceClient(sackmesser_ros::Interface *interface, const std::string &ns,
    ...
    GoalHeuristicForceServiceClient::~GoalHeuristicForceServiceClient() = default;

    GoalHeuristicForceServiceClient::Message::Request::SharedPtr GoalHeuristicForceServiceClient::encodeRequest(
      const ga_circular_fields_planner::ObstacleForceRequest &request) const
    {
        auto request_msg = std::make_shared<GoalHeuristicForceServiceClient::Message::Request>();
    ...
    ga_circular_fields_planner::ObstacleForceResponse GoalHeuristicForceServiceClient::decodeResponse(
...
REGISTER_CLASS(sackmesser_ros::base::CallbackClient, message_interface::GoalHeuristicForceServiceClient, "goal_heuristic_force");