...
#include <message_interface/ObstacleForceServiceClient.hpp>

namespace message_interface
{

    ObstacleForceServiceClient::ObstacleForceServiceClient(sackmesser_ros::Interface *interface, const std::string &ns,
    ...
    ObstacleForceServiceClient::~ObstacleForceServiceClient() = default;

    ObstacleForceServiceClient::Message::Request::SharedPtr ObstacleForceServiceClient::encodeRequest(
      const ga_circular_fields_planner::ObstacleForceRequest &request) const
    {
        auto request_msg = std::make_shared<ObstacleForceServiceClient::Message::Request>();
    ...
    ga_circular_fields_planner::ObstacleForceResponse ObstacleForceServiceClient::decodeResponse(
...
REGISTER_CLASS(sackmesser_ros::base::CallbackClient, message_interface::ObstacleForceServiceClient, "obstacle_force");