...
namespace message_interface
{
    ...
    class ObstacleHeuristicForceServiceClient
                                              ...
                                              percept_interfaces::srv::AgentStateToCircForce>
    {
      ...
      public:
        ObstacleHeuristicForceServiceClient(sackmesser_ros::Interface *interface, const std::string &ns, const std::string &callback_request,
                                   const std::string &callback_response);

        virtual ~ObstacleHeuristicForceServiceClient();
