...
namespace ga_circular_fields_planner
{
    ...
    class NavigationFunctionForce : public Force
    {
      public:
        NavigationFunctionForce(const sackmesser::Interface::Ptr &interface, const std::string &name);

        virtual ~NavigationFunctionForce();
