...
#include <message_interface/ObstacleHeuristicForceServiceClient.hpp>

namespace message_interface
{

    ObstacleHeuristicForceServiceClient::ObstacleHeuristicForceServiceClient(sackmesser_ros::Interface *interface, const std::string &ns,
    ...
    ObstacleHeuristicForceServiceClient::~ObstacleHeuristicForceServiceClient() = default;

    ObstacleHeuristicForceServiceClient::Message::Request::SharedPtr ObstacleHeuristicForceServiceClient::encodeRequest(
      const ga_circular_fields_planner::ObstacleForceRequest &request) const
    {
        auto request_msg = std::make_shared<ObstacleHeuristicForceServiceClient::Message::Request>();
    ...
    ga_circular_fields_planner::ObstacleForceResponse ObstacleHeuristicForceServiceClient::decodeResponse(
...
REGISTER_CLASS(sackmesser_ros::base::CallbackClient, message_interface::ObstacleHeuristicForceServiceClient, "obstacle_heuristic_force");