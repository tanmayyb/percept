...
namespace message_interface
{
    ...
    class VelocityHeuristicForceServiceClient
                                              ...
                                              percept_interfaces::srv::AgentStateToCircForce>
    {
      ...
      public:
        VelocityHeuristicForceServiceClient(sackmesser_ros::Interface *interface, const std::string &ns, const std::string &callback_request,
                                   const std::string &callback_response);

        virtual ~VelocityHeuristicForceServiceClient();
