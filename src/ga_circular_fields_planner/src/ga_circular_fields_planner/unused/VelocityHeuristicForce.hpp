...
namespace ga_circular_fields_planner
{
    ...
    class VelocityHeuristicForce : public Force
    {
      public:
        VelocityHeuristicForce(const sackmesser::Interface::Ptr &interface, const std::string &name);

        virtual ~VelocityHeuristicForce();
