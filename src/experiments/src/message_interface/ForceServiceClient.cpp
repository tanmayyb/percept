...
#include <message_interface/ForceServiceClient.hpp>

namespace message_interface
{

    ForceServiceClient::ForceServiceClient(sackmesser_ros::Interface *interface, const std::string &ns,
    ...
    ForceServiceClient::~ForceServiceClient() = default;

    ForceServiceClient::Message::Request::SharedPtr ForceServiceClient::encodeRequest(
      const ga_circular_fields_planner::ObstacleForceRequest &request) const
    {
        auto request_msg = std::make_shared<ForceServiceClient::Message::Request>();
    ...
    ga_circular_fields_planner::ObstacleForceResponse ForceServiceClient::decodeResponse(
...
REGISTER_CLASS(sackmesser_ros::base::CallbackClient, message_interface::ForceServiceClient, "apf_heuristic_force");
REGISTER_CLASS(sackmesser_ros::base::CallbackClient, message_interface::ForceServiceClient, "velocity_heuristic_force");
REGISTER_CLASS(sackmesser_ros::base::CallbackClient, message_interface::ForceServiceClient, "goal_heuristic_force");
REGISTER_CLASS(sackmesser_ros::base::CallbackClient, message_interface::ForceServiceClient, "goalobstacle_heuristic_force");
REGISTER_CLASS(sackmesser_ros::base::CallbackClient, message_interface::ForceServiceClient, "obstacle_heuristic_force");
REGISTER_CLASS(sackmesser_ros::base::CallbackClient, message_interface::ForceServiceClient, "random_heuristic_force");