...
namespace message_interface
{
    ...
    class GoalObstacleHeuristicForceServiceClient
                                              ...
                                              percept_interfaces::srv::AgentStateToCircForce>
    {
      ...
      public:
        GoalObstacleHeuristicForceServiceClient(sackmesser_ros::Interface *interface, const std::string &ns, const std::string &callback_request,
                                   const std::string &callback_response);

        virtual ~GoalObstacleHeuristicForceServiceClient();
