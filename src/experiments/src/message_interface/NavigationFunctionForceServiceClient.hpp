...
namespace message_interface
{
    ...
    class NavigationFunctionForceServiceClient
                                              ...
                                              percept_interfaces::srv::AgentStateToCircForce>
    {
      ...
      public:
        NavigationFunctionForceServiceClient(sackmesser_ros::Interface *interface, const std::string &ns, const std::string &callback_request,
                                   const std::string &callback_response);

        virtual ~NavigationFunctionForceServiceClient();
