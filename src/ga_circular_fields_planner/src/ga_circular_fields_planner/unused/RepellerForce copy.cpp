...
namespace ga_circular_fields_planner
{
    ...
    RepellerForce::RepellerForce(const sackmesser::Interface::Ptr &interface, const std::string &name) : interface_(interface)
    {
    ...
    gafro::Wrench<double> RepellerForce::computeForce(const Agent::State &state,  //
    ...
    bool RepellerForce::Configuration::load(const std::string &ns, const std::shared_ptr<sackmesser::Configurations> &server)
    {
...
REGISTER_CLASS(ga_circular_fields_planner::Force, ga_circular_fields_planner::RepellerForce, "apf_heuristic_force");
REGISTER_CLASS(ga_circular_fields_planner::Force, ga_circular_fields_planner::RepellerForce, "velocity_heuristic_force");
REGISTER_CLASS(ga_circular_fields_planner::Force, ga_circular_fields_planner::RepellerForce, "goal_heuristic_force");
REGISTER_CLASS(ga_circular_fields_planner::Force, ga_circular_fields_planner::RepellerForce, "goalobstacle_heuristic_force");
REGISTER_CLASS(ga_circular_fields_planner::Force, ga_circular_fields_planner::RepellerForce, "obstacle_heuristic_force");
REGISTER_CLASS(ga_circular_fields_planner::Force, ga_circular_fields_planner::RepellerForce, "random_heuristic_force");