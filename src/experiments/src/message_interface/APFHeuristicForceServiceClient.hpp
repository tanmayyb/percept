...
namespace message_interface
{
    ...
    class APFHeuristicForceServiceClient
                                              ...
                                              percept_interfaces::srv::AgentStateToCircForce>
    {
      ...
      public:
        APFHeuristicForceServiceClient(sackmesser_ros::Interface *interface, const std::string &ns, const std::string &callback_request,
                                   const std::string &callback_response);

        virtual ~APFHeuristicForceServiceClient();
